//
//  ViewController4x4FreeMode.swift
//  Sliding
//
...
class ViewController3x3FreeMode: UIViewController {
    ...
    @IBOutlet weak var coinLbel: UILabel!
    ...
    @IBAction func congsAlertBack(_ sender: Any) {
