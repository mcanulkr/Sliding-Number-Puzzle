...
class Board5x5View : UIView{
    ...
    override func layoutSubviews() {
        ...
        let board = appDelegate.board5x5  // get model from app delegate
        ...
        for r in 0 ..< 5 {      // manually set the bounds, and of each tile
            for c in 0 ..< 5 {
                ...
                if tile > 0 {
                    ...
                    button.layer.borderColor = UIColor(named: "color next level txt")?.cgColor
